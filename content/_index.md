...
```
┌──────────────────────────────────────────────────────────────┐
│  SOAR Development     │  4 end-to-end integrations built     │
│  SIEM Engineering     │  13+ use cases tuned, 10+ deployed   │
│  Incident Response    │  8+ security incidents investigated  │
│  Cloud Security       │  AWS Lambda, Azure Firewalls, WAF    │
│  Penetration Testing  │  Web app security, vuln validation   │
│  Security Automation  │  AI-augmented SOC workflows          │
│  Vulnerability Mgmt   │  Bug bounty triage, exceptions       │
│  Playbook Dev         │  10 IR playbooks authored            │
└──────────────────────────────────────────────────────────────┘
```
